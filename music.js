...
setInterval(() => {
  http.get(`http://arasat-.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
//كل البكجات
...
const CHANNELID = '776492670007771136'; // تعديل مهم ايدي الروم الصوتي

//البرفكس
const prefix = "8"; // تعديل مهم حط هنا البرفكس او مقدمة الامر
...
client.on('ready', () => {
    client.user.setActivity(`Arasat. 8help`,{ type: 'WATCHING' });
})
